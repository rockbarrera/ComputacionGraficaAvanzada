...
// Declaración de las partículas de fuego
...
void initParticleBuffersFire() {
	...
	// Allocate space for all buffers
	// Se cargan los datos de la partícula en memoria, la transferencia de la memoria será dinámica (los datos cambian) GL_DYNAMIC_COPY
	...
	// Inicialización de la edad de la partícula
	...
	// Se mezcla aleatoriamente las particulas. ------------------Revisar Posteriormente
	...
	// Se configuran los atributos de los vértices de las partículas.
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	// Crear un shader para las partículas de fuego {"Position", "Velocity", "Age"} Variables que vamos a estar retroalimentando
	...
	//Se crean datos aleatorios en el plano XY para generar la posición delas partículas
	...
	// De los datos aleatorios se guardan en forma de textura
	...
	while (psi) {
		...
		for(std::map<float, std::pair<std::string, glm::vec3> >::reverse_iterator it = blendingSorted.rbegin(); it != blendingSorted.rend(); it++){
			...
			// Renderizar el sistema de partículas de fuego
				...
				// Paso 2 Renderizar el sistema de partículas
